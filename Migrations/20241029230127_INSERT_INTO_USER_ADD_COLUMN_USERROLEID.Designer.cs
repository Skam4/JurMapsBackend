...
namespace JurMaps.Migrations
{
    ...
    [Migration("20241029230127_INSERT_INTO_USER_ADD_COLUMN_USERROLEID")]
    partial class INSERT_INTO_USER_ADD_COLUMN_USERROLEID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JurMaps.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserName = "admin",
                            UserPassword = "$2a$13$n7CWz1yTGsLnIBWaoCLrDuRENYG37WWCslR.2IZwRFJvoMU9o/fA2",
                            UserRoleId = 2
                        });
                });
