...
namespace JurMaps.Migrations
{
    ...
    [Migration("20250323013331_ALTER_TABLE_MAP_ADD_CREATION_DATE")]
    partial class ALTER_TABLE_MAP_ADD_CREATION_DATE
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JurMaps.Model.Map", b =>
                {
                    ...
                    b.Property<string>("MapCreationDate")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MapPublicationDate")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("JurMaps.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserName = "admin",
                            UserPassword = "$2a$13$0cs/MSYkJFviJC39vzGJoOzX/CPbwSgdjmGAiwuqxoNOs.MwzuqI6",
                            UserRoleId = 2
                        },
                        new
                        {
                            ...
                            UserName = "qwerty",
                            UserPassword = "$2a$13$98MI226Pq.HME6a5w64dm.SPnU5PzEixkOHykR.JYBFLzmuaANsxa",
                            UserRoleId = 1
                        });
                });

            modelBuilder.Entity("JurMaps.Model.UserMapLike", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JurMaps.Model.UserMapLike", b =>
                {
                    ...
                    b.HasOne("JurMaps.Model.User", "User")
